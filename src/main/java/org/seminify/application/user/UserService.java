...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return userDTO.setAuthorities(roleHierarchyImpl.getReachableGrantedAuthorities(userDTO.getAuthorities())
                .stream().map(grantedAuthority -> new AuthorityDTO().setAuthority(grantedAuthority.getAuthority()))
                .toList());
    }
